am4core.ready(function() {
    ...
    am4core.ready(function() {
      ...
      var backgroundColor = am4core.color("#5c636e");
      var activeColor = am4core.color("#f8b500");
      var confirmedColor = am4core.color("#4169E1");
      var recoveredColor = am4core.color("#9ACD32");
      var deathsColor = am4core.color("#DC143C");
    
      // for an easier access by key
      var colors = { active: activeColor, confirmed: confirmedColor, recovered: recoveredColor, deaths: deathsColor };
    
      var countryColor = am4core.color("#393e46");
      var countryStrokeColor = am4core.color("#511845");
      var buttonStrokeColor = am4core.color("#1c5fe5");
      ...
      bubbleSeries.tooltip.background.fillOpacity = 0.2;
      bubbleSeries.tooltip.background.fill = am4core.color("#000839");
      ...
      nameAndButtonsContainer.padding(0, 100, 5, 20);
      ...
      countryName.fill = am4core.color("#000839");
      ...
      slider.opacity = 0.7;
      slider.background.fill = am4core.color("#000839");
      ...
      dateAxis.renderer.grid.template.stroke = am4core.color("#000839");
      ...
      dateAxis.renderer.labels.template.fill = am4core.color("#000839");
      ...
      valueAxis.renderer.labels.template.fill = am4core.color("#000839");
      ...
      lineChart.legend.labels.template.fill = am4core.color("#000839");
      ...
      seriesTypeSwitch.leftLabel.fill = am4core.color("#000839");
      seriesTypeSwitch.rightLabel.fill = am4core.color("#000839");
      ...
      label.fill = am4core.color("#000839");
      ...
      function addButton(name, color) {
        ...
        button.label.fill = am4core.color("#000839");
